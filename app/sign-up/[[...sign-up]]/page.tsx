...
import { Mail, Lock, User, Loader2, Star, ChevronLeft, ChevronRight, Moon, Check } from 'lucide-react'
      ...
      <div className="flex w-full lg:w-1/2 flex-col justify-center items-center px-8 lg:px-12 py-10 overflow-y-auto">
        <div className="w-full max-w-[440px]">
          ...
          {/* <div className="mb-10">
            <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
              <div className="bg-black text-white p-2 rounded-xl">
                 <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/></svg>
              </div>
              <span className="font-bold text-2xl tracking-tight text-slate-900">SkillForge</span>
            </Link>
          </div> */}
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-100 hover:border-slate-200 text-slate-700 font-bold py-3.5 rounded-2xl transition-all disabled:opacity-50"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="John"
                    required
                    className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border-2 border-transparent focus:bg-white focus:border-slate-900 rounded-2xl outline-none transition-all font-medium text-slate-900"
                  />
                </div>
              </div>
              <div className="group">
                ...
                <input
                  ...
                  placeholder="Doe"
                  required
                  className="w-full px-5 py-3.5 bg-slate-50 border-2 border-transparent focus:bg-white focus:border-slate-900 rounded-2xl outline-none transition-all font-medium text-slate-900"
                />
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-transparent focus:bg-white focus:border-slate-900 rounded-2xl outline-none transition-all font-medium text-slate-900"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-slate-900 text-white py-4.5 rounded-2xl font-bold hover:bg-black active:scale-[0.98] transition-all disabled:opacity-70 flex items-center justify-center gap-2 text-lg shadow-xl shadow-slate-900/10 mt-2"
            >
              {isLoading ? (
                <>
